package com.padcmyanmar.ttm.groceryapp.network.remoteconfig
...
object FirebaseRemoteConfigManager {
    ...
    fun groceryListChangeLayout():Long{
        return remoteConfig.getValue("manScreenGroceryListChangeLayout").asLong()
    }
}